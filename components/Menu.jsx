      ...
      <div className="container flex align-center items-center">
        <div className="flex w-full">
          <Link href="/">
            <a>
              <div
                style={{ width: "140px", height: "50px", position: "relative" }}
              >
                <Image
                  src={Assets.Logo}
                  alt="pokemon"
            ...
            <a>
              <div className="flex flex-col mx-3 items-center cursor-pointer">
                <div className="flex">
                  ...
                  >
                    <Image
                      ...
                      alt="pokemon"
                      className={`${
                        curentPath === "/" ? "grayscale-0" : "grayscale"
                      }`}
                      layout="fill"
                      objectFit="contain"
                    />
                ...
                <div className="flex mt-2">
                  <span
                    className={`font-bold ${
                      curentPath === "/" ? "text-red-500" : "text-gray-500"
                    }`}
                  >
                    Pokemon
                  </span>
            ...
            <a>
              <div className="flex flex-col mx-3 items-center  cursor-pointer">
                <div className="flex">
                  ...
                  >
                    <Image
                      ...
                      alt="bags"
                      className={`${
                        curentPath === "/bags" ? "grayscale-0" : "grayscale"
                      }`}
                      layout="fill"
                      objectFit="contain"
                    />
                ...
                <div className="flex mt-2">
                  <span
                    className={`font-bold ${
                      curentPath === "/bags" ? "text-red-500" : "text-gray-500"
                    }`}
                  >
                    Bags
                  </span>
