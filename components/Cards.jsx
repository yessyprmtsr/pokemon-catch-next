      ...
      <div className="flex mt-10 justify-end w-full flex-col h-full">
        <div className="bg-gray-100 px-5 py-3 rounded-full flex shadow-sm justify-center">
          ...
          <div className="flex ml-3">
            <span className="text-black text-sm font-bold">{owned}</span>
          </div>
        </div>
        <div
          className="bg-gray-100 px-5 py-3 rounded-full flex shadow-sm cursor-pointer mt-2 justify-center"
        ...
        >
          ...
          <div className="flex ml-3">
            <span className="text-black text-sm">Catch !</span>
          </div>
        </div>
      </div>
    </div>
