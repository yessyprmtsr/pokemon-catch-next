      ...
      {detailData.length !== 0 ? (
        <div className="flex mt-20 px-3 justify-center mb-10">
          <div className="flex w-11/12 md:w-6/12 flex-col items-center">
            <Image
              src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${detailData.id}.png`}
              alt="poke-ball"
              width={200}
              height={200}
            />
            <div className="flex mb-10 flex-col">
              ...
              <div className="flex mt-4 justify-center">
                {detailData.types.map((type, i) => {
                  return (
                    <span
                      className="mx-1 bg-red-500 px-5 py-2 rounded-full text-white text-xs capitalize"
                      key={i}
                    >
                      {type.type.name}
                    </span>
            ...
            <div className="flex shadow w-full px-6 py-5 rounded-xl border flex-col">
              ...
              <div className="flex mt-5 flex-col">
                <div className="flex my-1">
                  <div className="flex w-8/12 md:w-3/12 text-gray-500">ID</div>
            ...
            <div className="flex shadow w-full px-6 py-5 rounded-xl border flex-col mt-5">
              ...
              <div className="flex mt-5 flex-col">
                <div className="flex my-1 items-center">
                  <div className="flex w-8/12 md:w-3/12 text-gray-500">HP</div>
                  <div className="flex w-8/12">
                    <div className="flex mr-2 w-1/12">
                      <span className="text-xs font-bold">
                        {detailData.stats[0].base_stat}
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        ...
                        style={{
                          width:
                            detailData.stats[0].base_stat > 100
                              ? 100 + "%"
                              : detailData.stats[0].base_stat + "%",
                        }}
                      ></div>
                  ...
                  <div className="flex w-8/12">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        ...
                        style={{
                          width:
                            detailData.stats[1].base_stat > 100
                              ? 100 + "%"
                              : detailData.stats[1].base_stat + "%",
                        }}
                      ></div>
                  ...
                  <div className="flex w-8/12">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        ...
                        style={{
                          width:
                            detailData.stats[2].base_stat > 100
                              ? 100 + "%"
                              : detailData.stats[2].base_stat + "%",
                        }}
                      ></div>
                  ...
                  <div className="flex w-8/12">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        ...
                        style={{
                          width:
                            detailData.stats[3].base_stat > 100
                              ? 100 + "%"
                              : detailData.stats[3].base_stat + "%",
                        }}
                      ></div>
                  ...
                  <div className="flex w-8/12">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        ...
                        style={{
                          width:
                            detailData.stats[4].base_stat > 100
                              ? 100 + "%"
                              : detailData.stats[4].base_stat + "%",
                        }}
                      ></div>
                  ...
                  <div className="flex w-8/12 items-center">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        ...
                        style={{
                          width:
                            detailData.stats[5].base_stat > 100
                              ? 100 + "%"
                              : detailData.stats[5].base_stat + "%",
                        }}
                      ></div>
              ...
              <div className="flex shadow w-full px-6 py-5 rounded-xl border flex-col mt-5">
                ...
                <div className="flex mt-5 flex-wrap">
                  {detailData.moves.map((mv, i) => {
                    return (
                      <span
                        className="px-4 py-2 rounded-full border m-1 text-xs"
                        key={i}
                      >
                        {mv.move.name}
                      </span>
